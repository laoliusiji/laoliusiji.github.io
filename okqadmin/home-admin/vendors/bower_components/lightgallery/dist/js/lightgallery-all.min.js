...
! function(a, b) {
	...
	! function() {
		...
		b.prototype.init = function() {
			...
			if(this.s.controls && this.$items.length > 1 && (d = '<div class="lg-actions"><button class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (f = '<div class="lg-sub-html"></div>'), b = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + c + '</div> <div id="niubi" >123132456</div> <div class="lg-toolbar lg-group"><span class="lg-close lg-icon"></span></div>' + d + f + "</div></div>", a("body").append(b), this.$outer = a(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), g.setTop(), a(window).on("resize.lg orientationchange.lg", function() {
					setTimeout(function() {
						g.setTop()
					}, 100)
		...
		}, b.prototype.goToin = function(a) {
//		    b.core.$outer.find(".lg-current .lg-image").length && (d -= b.core.s.scale, f())
		},b.prototype.goToOut = function(a) {
//		    ,b.core.$outer.find(".lg-current .lg-image").length && (d += b.core.s.scale, f())
...
//				b.deltaY && (b.deltaY > 0 ? a.goToPrevSlide() : 
//				
//				a.goToNextSlide(), b.preventDefault())
			})
	...
	! function() {
		...
		c.prototype.init = function() {
			...
			if(e.core.$outer.find(".lg").append('<div class="lg-pager-outer"></div>'), e.core.s.dynamic)
				for(var g = 0; g < e.core.s.dynamicEl.length; g++) f += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img onmousewheel="return bbimg(this)" src="' + e.core.s.dynamicEl[g].thumb + '" /></div></span>';
...
function(a, b) {
	...
	! function() {
		...
		c.prototype.init = function() {
			var b = this,
				c = '<span id="lg-share" style="display: none;" class="lg-icon"><ul class="lg-dropdown" style="position: absolute;display: none;">';
